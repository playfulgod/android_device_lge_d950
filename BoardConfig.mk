...
#BOARD_MKBOOTIMG_ARGS  := --ramdisk_offset 0x05000000 --dt device/lge/d950/dtb --tags_offset 0x04800000 ## For prebuilt kernel use to bypass g2-common
...
TARGET_OTA_ASSERT_DEVICE := d950,d959,gflex,galbi
